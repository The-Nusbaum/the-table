...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campaign" do
    assert_difference('Campaign.count') do
      post campaigns_url, params: { campaign: { name: @campaign.name, players: @campaign.players, user_id: @campaign.user_id } }
    end
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { name: @campaign.name, players: @campaign.players, user_id: @campaign.user_id } }
